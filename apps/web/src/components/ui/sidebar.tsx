...
function SidebarInset({ className, ...props }: React.ComponentProps<"main">) {
  return (
    <main
      ...
      className={cn(
        // min-w-0 lets this flex item shrink below its content width, so wide
        // inner content (e.g. the Kanban board) scrolls inside its own
        // container instead of stretching the whole page horizontally.
